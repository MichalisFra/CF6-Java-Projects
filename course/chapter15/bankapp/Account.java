...
public class Account extends IdentifiableEntity {
     ...
     * {@link Account}, thus increasing their {@link Account#balance}
     * @param amount
     ...
     *             if amount > {@link Account#balance}
     * @throws SsnNotValidException
     *             if the given ssn is not valid
     * @throws NegativeAmountException
     *             if the amount of money to be withdrawn is a negative number
     */
